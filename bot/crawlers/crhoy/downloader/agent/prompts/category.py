...
test_existing_categories = {
    "lifestyle": "news related to people's way of life, their choices, values and stories of their life",
    "lifestyle/expats": "news about Costa Ricans who are achieving significant success and recognition while living and working in other countries",
    "entertainment": "news and articles related to entertainment such as movies, music, TV and live events",
    "entertainment/celebrities": "news related to celebrities and prominent figures in the entertainment industry, including their personal lives, events (e.g., births, deaths, weddings, etc.), and achievements",
    "crime": "news about criminal activities and law enforcement",
    "crime/femicide": "News related to homicides specifically targeting women, often involving gender-based violence and related legal proceedings",
    ...
    "government/public_opinion": "News related to the public's sentiment, opinions, and reactions towards government actions, policies, and officials. It includes analysis of public perception and feedback on governmental decisions and their impact",
    ...
    "government/party_politics": "News related to the internal operations, elections, and decision-making processes within political parties",
    "weather": "news related to weather conditions, forecasts, and climate-related events",
    "culture/arts": "news related to artistic endeavors, cultural events, and figures",
    "sport/boxing": "news related to boxing as a sport, including fights, tournaments, and controversies surrounding the sport",
    "sport/baseball": "News related to baseball as a sport, including games, tournaments, and events surrounding the sport",
    "health/children": "news specifically related to the health and well-being of children, including public health issues, medical treatments, and healthcare policies affecting children",
    "economy/trade": "News related to economic activities, trade, commerce, and their impact on the country. This includes analysis of economic indicators, trade agreements, and issues affecting businesses",
    "transportation/aviation": "News related to air travel and aviation incidents",
    "incidents": "News related to accidents, disasters, and other unexpected events that cause harm or disruption",
    "incidents/infrastructure": "News related to accidents and incidents that cause damage to essential infrastructure, such as power grids, communication networks, roads, and water supply systems, and their resulting impact on services and communities",
    "education": "News related to educational policies, initiatives, student achievements, and other developments in the education sector",
    "education/awards": "News related to scholarships, grants, awards, and other forms of recognition within the education sector, covering student achievements and opportunities",
    "technology/internet_services": "News related to the functioning, outages, and security of internet-based services and platforms",
    "environment/parks": "News related to the establishment, maintenance, and conservation of parks and protected natural areas, including related policies and community involvement"
}